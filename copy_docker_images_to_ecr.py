...
docker pull 352914000000.dkr.ecr.us-west-1.amazonaws.com/litd/docker-cellranger:v6.0.0
...
ACCOUNT_ID = "352914000000"
REGION = ".dkr.ecr.us-west-1.amazonaws.com/"

IMAGE_TAGS = [
    "litd/docker-cellranger:v6.0.0",
]
...
def mirror_docker_hub_images_to_ecr(ecr_client, *, account_id, image_tags):
    ...
    for hub_tag in image_tags:
        ecr_tag = f"{account_id}{REGION}{hub_tag}"
...
if __name__ == "__main__":
    mirror_docker_hub_images_to_ecr(
        ecr_client=boto3.client("ecr", region_name='us-west-2'), account_id=ACCOUNT_ID, image_tags=IMAGE_TAGS
    )
